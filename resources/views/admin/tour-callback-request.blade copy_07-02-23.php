                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <select class="form-control" name="tour_id">
                                                        ...
                                                        <option value="{{ $tour->id }}" @if ($tour->id == $tour_id)
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <div class="switch-toggle">
                                                <div class="">
                                                    <label class="toggle" for="myToggleClass_{{ $s_no }}">
                                                        <input class="toggle__input myToggleClass_" @if ($val->status ==
                                                        1) checked @endif
                                        ...
                                        <td>{{ substr($val->note, 0, 30) }}<a class="infoRequestMessage"
                                                data-bs-toggle="modal" href="#infoRequestMessage"
                                                onclick='GetData("{{ $val->note }}")' role="button"><i
