        ...
        <div class="page-breadcrumb-action wd5">
            <div class="row g-2">
                ...
                <div class="col-md-4">
                    ...
                    <div class="TotalRequestoverview">Total Amount Received: <span>$0</span> </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="col-md-8">
                        <div class="BookingRequesttabs">
                            <ul class="nav nav-tabs">
                                <li><a  class="active"  href="#BookingRequest" data-bs-toggle="tab">Tour Booking Request</a></li>
                                <li><a href="#BookingAcceptedRequest" data-bs-toggle="tab">Tour Booking Accepted Request</a>
                                </li>
                            </ul>   
                        </div>
